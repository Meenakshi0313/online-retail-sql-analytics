...
Project documentation and architecture diagrams are available in the /docs folder:

Data Flow Diagram: DataFlow.drawio.png

Data Architecture Diagram: DataArchitect.drawio.png

These diagrams visually explain the flow of data from the Bronze layer to Silver and Gold layers, including transformations, tables, and views.

How to Run / Reproduce

Clone this repository to your local machine.

Place the raw CSV (online_retail.csv) in the /dataset folder.
...
Use the diagrams in /docs to understand the data flow and architecture.

Run the quality checks in /tests to validate the data before analysis.
